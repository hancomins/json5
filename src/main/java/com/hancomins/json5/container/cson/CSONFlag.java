...
/**
 * 이 클래스는 JSON5Type 구조의 각 코드 값에 해당하는 상수 플래그들과
...
class CSONFlag {
    ...
    static final short CSON_VERSION = 100;  // JSON5Type 버전
    static final int CSON_HEADER = 'C' << 24 | 'S' << 16 | 'O' << 8 | 'N';  // JSON5Type 헤더
    ...
    static final int JSON5_FOOTER = 0x18;
