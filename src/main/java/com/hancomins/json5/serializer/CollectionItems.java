...
class CollectionItems {
    ...
    private static Constructor<?> constructorOfCollection(Class<?> type) {
        try {
            ...
            throw new JSON5SerializerException("Collection field '" + type.getName() + "' has no default constructor");
        }
    }
    ...
    protected Collection<?> newInstance() {
        try {
            ...
            throw new JSON5SerializerException("Collection field '" + collectionType.getName() + "' has no default constructor");
        }
    }
}
