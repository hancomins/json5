...
public class JSON5Elements {

    private final static String BASE64_PREFIX = "base64,";

    private JSON5Elements() {
    }

    public static boolean equalsIgnoreTypes(JSON5Element JSON5Element, JSON5Element JSON5Element2) {
        return equals(JSON5Element, JSON5Element2, true);
    }

    public static boolean equals(JSON5Element JSON5Element, JSON5Element JSON5Element2) {
        return equals(JSON5Element, JSON5Element2, false);
    }

    private static boolean equals(JSON5Element JSON5Element, JSON5Element JSON5Element2, boolean ignoreTypes) {
        if(JSON5Element == JSON5Element2) {
            return true;
        }
        if(JSON5Element instanceof JSON5Object && JSON5Element2 instanceof JSON5Object) {
            return equals((JSON5Object) JSON5Element, (JSON5Object) JSON5Element2, ignoreTypes);
        }  else if(JSON5Element instanceof JSON5Array && JSON5Element2 instanceof JSON5Array) {
            return equals((JSON5Array) JSON5Element, (JSON5Array) JSON5Element2, ignoreTypes);
        }
        return false;
    }

    public static boolean equals(JSON5Object obj1, JSON5Object obj2) {
        return equals(obj1, obj2, false);
    }

    public static boolean equalsIgnoreTypes(JSON5Object obj1, JSON5Object obj2) {
        return equals(obj1, obj2, true);
    }

     private static boolean equals(JSON5Object obj1, JSON5Object obj2, boolean ignoreTypes) {
    ...
    public static boolean equals(JSON5Array array1, JSON5Array array2) {
        return equals(array1, array2, false);
    }

    public static boolean equalsIgnoreTypes(JSON5Array array1, JSON5Array array2) {
        return equals(array1, array2, true);
    }


    private static boolean equals(JSON5Array array1, JSON5Array array2, boolean ignoreTypes) {
    ...
    private static boolean equalsObject(Object value1, Object value2, boolean ignoreType) {
        ...
        if (value1 instanceof JSON5Element && value2 instanceof JSON5Element) {
            return equals((JSON5Element) value1, (JSON5Element) value2, ignoreType);
        }
